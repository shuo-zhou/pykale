...
def read_csv_numeric(csv_path: str, index_col: list) -> np.array:
    ...
    Args:
        ...
        index_col (list): Columns that should be treated as levels of a Pandas Dataframe MultiIndex. There should be an
    ...
    value_counts_by_level = [dataframe.index.get_level_values(level).value_counts().to_numpy for level in index_col]
